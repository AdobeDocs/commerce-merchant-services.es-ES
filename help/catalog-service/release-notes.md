...
![Nuevo](../assets/new.svg) El [`products`](https://developer.adobe.com/commerce/services/graphql/catalog-service/products/) query ahora devuelve datos de opciones personalizables para productos simples y complejos.<!--DATA-5538-->
