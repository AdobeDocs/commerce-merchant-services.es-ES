...
>[!NOTE]
>
>Desde marzo de 2023, Live Search solo admite la versión 2.4.4 y posteriores.
...
1. Espere al menos una hora para que los datos se indexen y sincronicen. A continuación, utilice el [Zona de reproducción de GraphQL](https://developer.adobe.com/commerce/webapi/graphql/schema/live-search/) con la consulta predeterminada para verificar lo siguiente:
...
1. Si su `magento/live-search` versión es `2.0.3` o inferior, y está actualizando a la versión `3.0.0` o superior, ejecute el siguiente comando antes de la actualización:
...
| `data-services` | Necesario para configurar la conexión a Commerce Services. |
| `services-id` | Necesario para configurar la conexión a Commerce Services. |
