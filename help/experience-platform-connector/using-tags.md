...
1. Correo electrónico de la cuenta:
   ...
   - **[Opcional] ruta**: `accountContext.accountEmail`
...
1. Precio del producto:
   ...
   - **Abrir editor**: `return _satellite.getVar('product regular price') || _satellite.getVar('product special price')`
