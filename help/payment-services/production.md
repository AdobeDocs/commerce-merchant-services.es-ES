...
Consulta [Configurar servicios de pago](settings.md) para obtener más información sobre cómo configurar los campos de tarjeta de crédito y los botones de pago de PayPal.
...
Para permitir que tus tiendas se activen, solicita el derecho de pagos desde el Adobe (solo para [incorporación avanzada](#advanced-onboarding)):
...
También puedes solicitar el derecho a pagos desde el Adobe en [business.adobe.com](https://business.adobe.com/resources/payment-services.html).
