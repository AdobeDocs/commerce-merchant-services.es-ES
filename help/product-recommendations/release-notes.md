...
![Nuevo](../assets/new.svg) El producto Recommendations ahora tiene un GraphQL [`recommendations`](https://developer.adobe.com/commerce/webapi/graphql/schema/product-recommendations/queries/recommendations/) consulta.
