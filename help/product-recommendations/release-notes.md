...
![Nuevo](../assets/new.svg) Se ha introducido el [`recommendations`](https://developer.adobe.com/commerce/webapi/graphql/schema/product-recommendations/queries/recommendations/) API de GraphQL.
