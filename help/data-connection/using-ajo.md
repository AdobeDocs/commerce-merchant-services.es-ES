...
- Usted [configurado](connect-data.md) el [!DNL Data Connection] extensión
- Usted [confirmado](connect-data.md#confirm-that-event-data-is-collected) Compruebe que los datos del evento de Commerce llegan al perímetro del Experience Platform
...
1. En el panel de navegación derecho, configure el evento de la siguiente manera:
   ...
   1. Seleccionar **[!UICONTROL Fields]** y en el **[!UICONTROL Fields]** , seleccione los campos que sean útiles para este evento. Por ejemplo, seleccione todos los campos bajo la etiqueta **[!UICONTROL Product list items]**, **[!UICONTROL Commerce]**, **[!UICONTROL eventType]**, y **[!UICONTROL Web]**.
