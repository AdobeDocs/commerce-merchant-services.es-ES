...
### Sincronización de indexación de precios SaaS
...
### Sincronizando servicio de catálogo

Para realizar una resincronización del servicio de catálogo, es importante ejecutar los comandos en este orden:
